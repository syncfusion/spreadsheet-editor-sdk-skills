...
methods: {
  onCreated() {
    ...
    spreadsheet.setRowHeight(30, 1);          // Row 2 height = 30
    spreadsheet.setColWidth(120, 0);          // Column A width = 120
    spreadsheet.setRowsHeight(40, ["1:4"]);   // Rows 1–4 height = 40
    spreadsheet.setColumnsWidth(150, ["C:G"]); // Columns C–G width = 150
    // === Hide / Show Rows ===
    spreadsheet.hideRow(3, 5, true);          // Hide rows 4–6
    spreadsheet.hideRow(4, 5, false);         // Show rows 4–6
    // === Hide / Show Columns ===
    spreadsheet.hideColumn(1, 4, true);       // Hide columns B–E
    spreadsheet.hideColumn(2, 4, false);      // Show columns B–E
    // === Auto Fit Columns ===
...
Vue Spreadsheet uses the **insertRow()**, **insertColumn()** and **delete()** methods.
