# Notes Feature — Syncfusion Vue Spreadsheet

The **Notes** feature in the Syncfusion Vue Spreadsheet allows you to add plain text annotations to cells, useful for comments, feedback, and quick review notes. Notes can be inserted through JS, UI interactions, or programmatically.
...
```vue
<ejs-spreadsheet :enableNotes="true" />
```

Disable all note features:

```vue
<ejs-spreadsheet :enableNotes="false" />
```

## 2. Adding Notes in JS (Initialization)
