...
function Default() {
    ...
    return (<SpreadsheetComponent ref={spreadsheetRef} allowNumberFormatting={true} created={onCreated}>
                    <SheetsDirective>
                        <SheetDirective name="Finance">
                        </SheetDirective>
                    </SheetsDirective>
...
```jsx
//import getFormatFromType from '@syncfusion/ej2-react-spreadsheet' to get the format code from format type.
