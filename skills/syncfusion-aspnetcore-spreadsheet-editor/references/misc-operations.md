# Miscellaneous Sheet Operations — Syncfusion ASP.NET Core Spreadsheet

This guide covers Autofill, clearing content/formatting, sheet management (insert / move / delete), navigation, and clipboard operations in the **Syncfusion ASP.NET Core Spreadsheet**.
...
<div class="control-pane">
    <div class="control-section spreadsheet-control">
        <ejs-spreadsheet id="spreadsheet" allowAutoFill="true" created="onCreated">
