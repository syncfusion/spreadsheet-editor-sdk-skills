# Data Validation in Spreadsheet Editor (ASP.NET Core)
...
<div class="control-pane">
    <div class="control-section spreadsheet-control">
        <ejs-spreadsheet id="spreadsheet" allowDataValidation="true" created="onCreated">
            <e-spreadsheet-sheets>
                <e-spreadsheet-sheet name="Orders">
                </e-spreadsheet-sheet>
            </e-spreadsheet-sheets>
        </ejs-spreadsheet>
    </div>
