...
<div class="control-pane">
    <div class="control-section spreadsheet-control">
        <ejs-spreadsheet id="spreadsheet" created="onCreated" fileMenuBeforeOpen="fileMenuBeforeOpen">
            <e-spreadsheet-selectionsettings mode="Multiple"></e-spreadsheet-selectionsettings>
...
<script>
    // selectionSettings declared as a JS var (parity with the ASP.NET Core sample)
...
```cshtml
<ejs-spreadsheet id="spreadsheet" created="onCreated" allowEditing="false">
    <e-spreadsheet-sheets>
        <e-spreadsheet-sheet name="Sheet1"></e-spreadsheet-sheet>
    </e-spreadsheet-sheets>
</ejs-spreadsheet>
