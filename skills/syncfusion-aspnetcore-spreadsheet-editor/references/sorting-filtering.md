...
<div class="control-pane">
    <div class="control-section spreadsheet-control">
        <ejs-spreadsheet id="spreadsheet" allowSorting="true" allowFiltering="true" created="onCreated">
            <e-spreadsheet-sheets>
                <e-spreadsheet-sheet name="SalesData">
                    <e-spreadsheet-ranges>
                        <e-spreadsheet-range dataSource="salesData"></e-spreadsheet-range>
                    </e-spreadsheet-ranges>                 
                </e-spreadsheet-sheet>
            </e-spreadsheet-sheets>
        </ejs-spreadsheet>
