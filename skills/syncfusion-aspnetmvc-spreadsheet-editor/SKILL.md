...
5. **Only after the user selects a delivery mode**, proceed to generate ASP.NET MVC(cshtml) code using the APIs and snippets from `references/*.md`, substituting concrete placeholders from the user's project.
