...
@Html.EJS().Spreadsheet("spreadsheet").AllowMerge(true).Created("onCreated").Sheets(sheet =>
{
    sheet.Name("Report").Rows(row =>
    {
        row.Cells(cell =>
        {
            cell.Value("Project").Add();
            cell.Value("").Add();
            cell.Value("Budget").Add();
        }).Add();
        
        row.Cells(cell =>
        {
            cell.Value("Widget A").Add();
            cell.Value("10000").Add();
            cell.Value("").Add();
        }).Add();
        
        row.Cells(cell =>
        {
            cell.Value("Widget B").Add();
            cell.Value("15000").Add();
            cell.Value("").Add();
        }).Add();
    }).Add();
}).Render()
