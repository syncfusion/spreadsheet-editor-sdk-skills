...
@Html.EJS().Spreadsheet("spreadsheet").SelectionSettings(selectionSettings).BeforeSelect("beforeSelect").Select("onSelect").Created("onCreated").Sheets(sheet =>
{
...
@Html.EJS().Spreadsheet("spreadsheet").Select("onSelect").Sheets(sheet =>
{
    sheet.Name("Sheet1").Add();
}).Render()
...
@Html.EJS().Spreadsheet("spreadsheet").BeforeSelect("beforeSelect").Sheets(sheet =>
{
    sheet.Name("Sheet1").Add();
}).Render()
